...
import { detectCompetitionLevel, isRiflePistolCompetition } from "@shootermarkt/adapters/issf/competition-level";
import { db } from "@shootermarkt/db";
import { competitions, countries } from "@shootermarkt/db/schema";
